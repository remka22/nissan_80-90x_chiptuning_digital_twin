...
PROG = [
    ...
    (None,     "LDAA#", 0x05),          # RMCR=0x05: ВНУТРЕННИЙ клок, async 8-бит, E/128
                                        # (медленно = длинный бит = устойчиво к RC-размазке фронтов;
                                        #  E/16=0x04 был слишком быстр, сигнал не успевал)
