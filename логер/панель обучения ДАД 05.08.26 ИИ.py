...
LABELS = [
    ...
    (0x144B, "Расход (прослойка)",    8, "0 или 255 = упёрлись в зажим", None),
    (0x00FA, "VE (ДАД)",    8, "× (1.00 = нет)",     0.0078125),  # карта 0x4900
    (0x00FB, "Ktps (ДАД)",  8, "× (1.00 = нет)",     0.0078125),  # карта 0x4B00
